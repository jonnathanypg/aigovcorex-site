    ...
    <div className="min-h-screen py-24 px-4 max-w-4xl mx-auto space-y-8">
      ...
      <div className="glass-panel p-8 rounded-3xl space-y-6 text-sm text-gray-700 dark:text-slate-300 leading-relaxed border border-white/40 dark:border-white/10">
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">{t('legal.privacySec1Title')}</h2>
          <p>{t('legal.privacySec1Text')}</p>
        </section>

        <section className="space-y-2">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">{t('legal.privacySec2Title')}</h2>
          <p>{t('legal.privacySec2Text')}</p>
        </section>

        <section className="space-y-2">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">{t('legal.privacySec3Title')}</h2>
          <p>{t('legal.privacySec3Text')}</p>
        </section>
      </div>
    </div>
  );
